...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { score: @history.score, user_id: @history.user_id, word_id: @history.word_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { score: @history.score, user_id: @history.user_id, word_id: @history.word_id } }
